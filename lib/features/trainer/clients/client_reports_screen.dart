// lib/features/trainer/clients/client_reports_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:intl/intl.dart';
import '../../../core/models/models.dart';
import '../../../core/services/auth_provider.dart';
import 'client_weight_log_screen.dart';
import '../../client/progress/exercise_progress_screen.dart';

class TrainerClientReportsScreen extends StatelessWidget {
  final String clientId;
  final String clientName;

  const TrainerClientReportsScreen({
    super.key,
        ...
        children: [
          _ReportCard(
            ...
            onTap: () => Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => ClientWeightLogScreen(
                clientId: clientId,
  ...
  void _pickExercise(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (ctx) => _ExercisePickerSheet(
        loadExercises: () => context.read<AuthProvider>().api.getExercises(),
        onSelected: (exercise) {
  ...
  void _pickDateAndShowCalories(BuildContext context) async {
    ...
    try {
      final result =
          await api.getTrainerClientBurnedCalories(clientId, dateStr);
